...
| Lead T Router | Lead Directed Router | `copper/3`, `lead/3` | One-way router that distributes back input to left and right after a short delay. |
...
| Silicon T Router | Lead T Router | `copper/3`, `lead/3`, `silicon/3` | One-way instant router that distributes back input to left and right. |
